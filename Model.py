...
# 1. Input layer
# - Dense(128): Adds a fully connected (dense) layer with 128 neurons.
...
# 2. Dropout layer
# - Dropout(0.1): Adds a dropout layer that randomly sets 10% of the input units to zero during training to prevent overfitting. 
...
# - Dense(64): Adds another dense layer with 128 neurons.
